...
namespace Tools.ViewModel.ModuleViewModel
{
    ...
    public class ImageToolViewModel: ViewModelBase
    {
        public ImageToolViewModel()
        {
            ...
            {
                new ControlModel("图片格式转换", typeof(Image2Pdf)),
                new ControlModel("图片转ASCii字符", typeof(Image2AsciiCharacters)),
            };
        ...
        public ControlModel CurrentShowControl
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(nameof(CurrentShowControl.Content));
                RaisePropertyChanged(nameof(CurrentShowControl.Title));
            }
        }
